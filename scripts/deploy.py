...
class Uploader:
    ...
    def __init__(self, bucket, profile="default", prefix="ns/"):
    ...
    def upload(self, path, mime_type):
        ...
        try:
            with open(path, 'rb') as fp:
                self.s3.upload_fileobj(fp, self.bucket,
...
if __name__ == '__main__':
    ...
    uploader.upload("trellis.ttl", "text/turtle")
    uploader.upload("trellis.html", "text/html")
    uploader.upload("trellis.jsonld", "application/ld+json")
    uploader.upload("trellis.rdf", "application/rdf+xml")
    uploader.upload("trellisresource.jsonld", "application/ld+json")
    uploader.upload("css/style.css", "text/css")
